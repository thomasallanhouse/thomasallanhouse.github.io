...
BLOG_AUTHOR = "Thomas House"  # (translatable)
...
BLOG_EMAIL = "thomas.house@manchester.ac.uk"
BLOG_DESCRIPTION = "Thomas House's Personal Website"  # (translatable)
...
REDIRECTIONS = [("/index.html", "about.html"), ("/default.htm", "about.html")]
# REDIRECTIONS = []
...
<style type="text/css"> @import "./assets/css/custom.css"; </style>
"""
